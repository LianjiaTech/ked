...
module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.charts': 'KeCharts',
    'app.header.menu.gem': '原石',
    ...
    'app.home.components-explain':
      '基于 KED 设计语言，我们提供了开箱即用的高质量 React 和 Angular 组件实现，用于开发和服务于企业级中后台产品。',
    'app.home.product-pro-slogan': '开箱即用的中台前端/设计解决方案',
    'app.home.product-mobile-slogan': 'ked-mobile 是 KED 移动规范的实现',
    'app.home.product-antv-slogan': '简单、专业、拥有无限可能的数据可视化解决方案',
    'app.home.product-landing-slogan': '基于 KED 设计语言的 Landing 模板与规范',
    'app.home.tool-title': '工具和资源',
    'app.home.tool-package-title': 'KED 资源包',
    'app.home.tool-package-content': 'KED 相关设计资源下载',
