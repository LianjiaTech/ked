...
module.exports = {
  ...
  messages: {
    ...
    'app.home.components-explain':
      'Based on the KED language, we have provided a suite of out-of-the-box with high quality for developing and serving enterprise background applications,including the official React implementation and Angular, Vue implementations',
    'app.home.product-pro-slogan': 'Out-of-the-box front-end / Design solution',
    'app.home.product-mobile-slogan':
      "antd-mobile is the implementation of KED's mobile specification",
    'app.home.product-landing-slogan':
      'Landing Pages templates and specifications based of KED language',
    ...
    'app.home.tool-package-title': 'KED Resources',
    'app.home.tool-package-content': 'KED Resources Download',
    ...
    'app.home.more-mobile-react': 'KED Mobile of React',
    'app.home.more-mobile-angular': 'KED Mobile of Angular',
    'app.footer.repo': 'GitHub Repository',
    'app.footer.awesome': 'Awesome KED',
    'app.footer.course': 'KED Practical Tutorial',
