...
import { Radio, Icon, Input } from '@ke/ked'
import { RadioChangeEvent } from '@ke/ked/es/radio/radio/interface'
import { injectIntl } from 'react-intl'
import debounce from 'lodash/debounce'
import { ThemeType } from '@ke/ked/es/icon'
    ...
    return Object.keys(IconDisplay.categories)
      .map((category: CategoriesKeys) => ({
        ...
        icons: (IconDisplay.categories[category] || []).filter(
          name => manifest[IconDisplay.themeTypeMapper[theme]].indexOf(name) !== -1,
        ),
      }))
