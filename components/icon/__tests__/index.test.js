  ...
  describe('warning on conflicting theme', () => {
    ...
    it('warns', () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith(
        "Warning: [ked: Icon] The icon name 'clock-circle-o' already specify a theme 'outlined', the 'theme' prop 'filled' will be ignored.",
      );
    });
  });
...
describe('utils', () => {
  ...
  it('should report an error when there are deprecated typos in icon names', () => {
    ...
    expect(errorSpy).toHaveBeenLastCalledWith(
      "Warning: [ked: Icon] Icon 'interation' was a typo and is now deprecated, please use 'interaction' instead.",
    );
    render(<Icon type="cross" />);
    expect(errorSpy).toHaveBeenLastCalledWith(
      "Warning: [ked: Icon] Icon 'cross' was a typo and is now deprecated, please use 'close' instead.",
    );
    render(<Icon type="canlendar" theme="twoTone" />);
    expect(errorSpy).toHaveBeenLastCalledWith(
      "Warning: [ked: Icon] Icon 'canlendar' was a typo and is now deprecated, please use 'calendar' instead.",
    );
    render(<Icon type="colum-height" />);
    expect(errorSpy).toHaveBeenLastCalledWith(
      "Warning: [ked: Icon] Icon 'colum-height' was a typo and is now deprecated, please use 'column-height' instead.",
    );
