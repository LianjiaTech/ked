...
```jsx
import { Typography, Divider } from '@ke/ked'
...
ReactDOM.render(
  <Typography>
    ...
    <Paragraph>
      After massive project practice and summaries, Ke Design, a design language for background
      applications, is refined by UED Team, which aims to{' '}
      <Text strong>
    ...
    <Paragraph>
      ...
      Ke Design。基于<Text mark>『确定』和『自然』</Text>
