...
export default class Form extends React.Component<FormProps, any> {
  ...
  static propTypes = {
    ...
    labelLeft5: PropTypes.bool,
    labelLeft8: PropTypes.bool,
  };
  ...
  constructor(props: FormProps) {
    ...
    warning(!props.form, 'Form', 'It is unnecessary to pass `form` to `Form` in current version');
  }

  renderForm = ({ getPrefixCls }: ConfigConsumerProps) => {
    const { prefixCls: customizePrefixCls, hideRequiredMark, className = '', layout, labelLeft5, labelLeft8 } = this.props;
    ...
    const formClassName = classNames(
      prefixCls,
      {
        ...
        [`${prefixCls}-label-left-5`]: !!labelLeft5,
        [`${prefixCls}-label-left-8`]: !!labelLeft8,
      },
      className,
    );
