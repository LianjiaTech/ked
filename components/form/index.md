...
| labelLeft5 | 标题居左最多展示5个字符  | boolean | false | 3.15.0 |
| labelLeft8 | 标题居左最多展示8个字符  | boolean | false | 3.15.0 |
...
```tsx
import { Form } from '@ke/ked'
import { FormComponentProps } from '@ke/ked/es/form';
...
<style>
.code-box-demo .ked-form:not(.ked-form-inline):not(.ked-form-vertical) {
  max-width: 600px;
}
...
import Form, { FormComponentProps } from '@ke/ked/lib/form/Form';
