  ...
  describe('warning use if use invalidate moment', () => {
    ...
    it('defaultValue', () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith(
        'Warning: [ked: DatePicker] `defaultValue` provides invalidate moment time. If you want to set empty value, use `null` instead.',
      );
    });
    ...
    it('value', () => {
      ...
      expect(errorSpy).toHaveBeenCalledWith(
        'Warning: [ked: DatePicker] `value` provides invalidate moment time. If you want to set empty value, use `null` instead.',
      );
    });
  });
});
